...
const CategoryPage = () => {
    ...
    const handleAddItem = async () => {
        const url = 'http://localhost:8080/category/create';
        const data = {
          categoryName,
          status,
          tags,
    ...
    return (
        <div className="dashbord-page">
            ...
            <div class="dashbord">
                <div class="title">
                    <h2>Categories</h2>
                    <img class="bell category-navbar" src={bell} alt="" />
                ...
                <div class="summery">
                    <div class="summery-sales">
                                    ...
                                    <DialogContent dividers={scroll === 'paper'}>
                                        <div class="newWindow">
                                            ...
                                            <div class="row">
                                                <div class="column">
                                                    <h5>Tags/Labels</h5>
                                                    <input class="long" type="text" value={tags} onChange={(e) => setTags(e.target.value)}/>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="column">
                                                    <h5>Description</h5>
                                                    <input class="long"  type="text" value={description} onChange={(e) => setDescription(e.target.value)}/>
                                                </div>

                                            </div>

                                            <button onClick={handleAddItem} class="add-item">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z" /></svg>
                                                <h3>Add Item</h3>
                                            </button>
                                        </div>
                        ...
                        <table class="sample-table category-table">
                            <thead>
                                <tr class="heading">
                                    <th class="tick-column"></th>
                                    <th><span>Category ID</span><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M440-160v-487L216-423l-56-57 320-320 320 320-56 57-224-224v487h-80Z" /></svg></th>
                                    <th><span>Category Name</span><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M320-440v-287L217-624l-57-56 200-200 200 200-57 56-103-103v287h-80ZM600-80 400-280l57-56 103 103v-287h80v287l103-103 57 56L600-80Z" /></svg></th>
                                    <th><span>Total Items</span><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M320-440v-287L217-624l-57-56 200-200 200 200-57 56-103-103v287h-80ZM600-80 400-280l57-56 103 103v-287h80v287l103-103 57 56L600-80Z" /></svg></th>
                                    <th><span>Date Added</span><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M320-440v-287L217-624l-57-56 200-200 200 200-57 56-103-103v287h-80ZM600-80 400-280l57-56 103 103v-287h80v287l103-103 57 56L600-80Z" /></svg></th>
                                    
                                    <th><span>Image</span></th>
                                    <th><span>Tages</span><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M320-440v-287L217-624l-57-56 200-200 200 200-57 56-103-103v287h-80ZM600-80 400-280l57-56 103 103v-287h80v287l103-103 57 56L600-80Z" /></svg></th>
                                    <th><span>Status</span><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M320-440v-287L217-624l-57-56 200-200 200 200-57 56-103-103v287h-80ZM600-80 400-280l57-56 103 103v-287h80v287l103-103 57 56L600-80Z" /></svg></th>
                                    <th><span>Description</span><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M320-440v-287L217-624l-57-56 200-200 200 200-57 56-103-103v287h-80ZM600-80 400-280l57-56 103 103v-287h80v287l103-103 57 56L600-80Z" /></svg></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
